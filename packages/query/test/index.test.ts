...
import { morphicOpaqueRequest, morphicRequest, StandardRequest } from "../src/Request"
...
export const testProductDS = DS.fromFunctionBatched("TestProducts")<GetProduct>((_) =>
  _.map((_) => ({
...
export const GetAssetError = MO.opaque<GetAssetErrorE, GetAssetError>()(GetAssetError_)
...
const GetAsset_ = morphicRequest("GetAsset", GetAssetPayload, GetAssetError, Asset)
...
export const assetDS = DS.fromFunctionBatched("AssetDS")((_: readonly GetAsset[]) =>
  _.map((a) =>
